...
<!-- /*---------- end of navigation bar section ----------*/ -->`;M(document.querySelector("header"));function B(){const e=document.querySelector(".carousel-img");console.log(e);let l=!1,o=0,a=0,i=0;const n=Array.from(e.children)[0].offsetWidth;e.addEventListener("mousedown",h),e.addEventListener("touchstart",h,{passive:!0}),e.addEventListener("mouseup",c),e.addEventListener("mouseleave",c),e.addEventListener("touchend",c,{passive:!0}),e.addEventListener("mousemove",v),e.addEventListener("touchmove",v,{passive:!0});const d=document.getElementById("left"),r=document.getElementById("right");d.addEventListener("click",u),r.addEventListener("click",b);function h(t){t.type==="touchstart"?o=t.touches[0].clientX:(o=t.clientX,l=!0),i=a,e.style.transition="none"}function v(t){if(l){const m=(t.type==="touchmove"?t.touches[0].clientX:t.clientX)-o;a=i+m,e.style.transform=`translateX(${a}px)`}}function c(){l=!1,e.style.transition="transform 0.3s ease-out";const t=a%n;Math.abs(t)>n/2?a-=(n-Math.abs(t))*Math.sign(t):a-=t,a=Math.max(a,-e.scrollWidth+e.offsetWidth),a=Math.min(a,0),e.style.transform=`translateX(${a}px)`}function u(){a+=n,c()}function b(){a-=n,c()}}const E=[{img:"src/public/nike_Image/nike_shoe/air-force-1-07-womens-shoes-b19lqD.png"},{img:"src/public/nike_Image/nike_shoe/nike-just-Air-Max.jpg"},{img:"src/public/nike_Image/nike_shoe/nike-just-Blazer.jpg"},{img:"src/public/nike_Image/nike_shoe/nike-just-do-it (1).jpg"},{img:"src/public/nike_Image/nike_shoe/nike-shoe-Air-joradan.jpg"}],T=E.map(e=>`
        <img
            src="${e.img}"
            draggable="false"
        />
...
`;B(document.querySelector(".shoe-carousel"));const x=document.querySelector(".card-container"),I=[{img:"/Users/anbschool0016/Desktop/nike-test/Deploy_Nike_page/src/public/nike_Image/nke_images/nike_hiking.jpeg",header:"Latest From Jordan",sub_header:"Air Jordan 11 Retro Low OG"},{img:"/nike_Image/nke_images/fitness.jpg",header:"Make Your Move",sub_header:"Fitness Essentials"},{img:"src/public/nike_Image/nke_images/running.jpg",header:"Nike Trails GR11 Pack",sub_header:"Featuring the Zegama 2"},{img:"src/public/nike_Image/nke_images/golfman.jpg",header:"Brooks Koepka's Picks",sub_header:"AF1s, Golf Shoes & More"}];I.forEach(e=>{x.innerHTML+=`
        <div class="column">
            <div class="overlay">
                <p>${e.header}</p>
